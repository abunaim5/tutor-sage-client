    ...
    return (
        <Box>
                ...
                <CardBody display='flex' justifyContent='space-between'>
                    <Box display='flex' alignItems='center' gap={6}>
                        ...
                        <Box>
                            ...
                            <Text my={1} fontWeight={600}>{role}</Text>
                            <Text fontWeight={600}>Los Angeles, California, USA</Text>
                        </Box>
                    </Box>
            ...
            <Card mt={6}>
                <CardBody display='flex' justifyContent='space-between'>
                    <Box>
                        <Heading fontSize='2xl' fontFamily='body'>Personal information</Heading>
            ...
            <Card mt={6}>
                <CardBody display='flex' justifyContent='space-between'>
                    <Box>
                        <Heading fontSize='2xl' fontFamily='body'>Address</Heading>
