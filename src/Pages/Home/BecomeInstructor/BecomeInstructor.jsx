        ...
        <Box className="flex flex-col lg:flex-row">
            ...
            <Box className="w-full lg:w-1/2" bg='primary.500' display='flex' alignItems='center'>
                <Box textColor='white' px={{base: 6, md: 10}} py={10}>
                    <Heading fontFamily='body' size={{base: 'lg', md: 'xl'}}>Become an instructor</Heading>
                    <Text mt={3} fontSize={{base: 'sm', md: 'md'}}>Inspire and educate the next generation by becoming an instructor. <br /> Create impactful courses and reach a global audience.</Text>
