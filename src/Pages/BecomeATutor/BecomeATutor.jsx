import { Box, Button, Card, FormControl, FormErrorMessage, FormLabel, Heading, Input, Select } from "@chakra-ui/react";
    ...
    return (
        <Box bg={`url(${tutorImg})`} bgPos='center' bgRepeat='no-repeat' bgSize='cover' bgAttachment='fixed' minH='calc(100vh - 104px)'>
            <Box className="bg-black/50" minH='calc(100vh - 104px)' display='flex' justifyContent='center' alignItems='center'>
                <Card minW='4xl' mx='auto' p={6} rounded='none' bg='none' textColor='white'>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Button type="submit" colorScheme="primary" borderRadius='none' mt={6} w='100%'>Review</Button>
                    </form>
                </Card>
            </Box>
        </Box>
